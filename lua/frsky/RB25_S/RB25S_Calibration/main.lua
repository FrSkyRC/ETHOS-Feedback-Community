...
local SXR_CALI_HINTS = {
  ...
  "Place your RB25 vertical, pins up.",
  "Place your RB25 vertical, pins down.",
  "Place your RB25 legible lettering, pins right.",
  "Place your RB25 not legible lettering, pins left.",
}
      ...
      if value then
        ...
        if fieldId == 0x60 then
          if step == 5 then
            ...
            bitmap = lcd.loadBitmap("/scripts/RB25S_Calibration/cali_ok.png")
          else
            calibrationState = CALIBRATION_INIT
            step = (step + 1) % 6
            bitmap = lcd.loadBitmap("/scripts/RB25S_Calibration/cali_"..step..".png")
