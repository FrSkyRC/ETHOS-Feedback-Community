...
local i18nMap = {
  en = assert(loadfile(RB35GlobalPath .. "i18n/en.lua"))(),
}

local i18nFiles = system.listFiles(RB35GlobalPath .. "i18n")
for _, value in ipairs(i18nFiles) do
  if value == (locale .. ".lua") then
    i18nMap[locale] = assert(loadfile(RB35GlobalPath .. "i18n/" .. locale .. ".lua"))()
  end
end
