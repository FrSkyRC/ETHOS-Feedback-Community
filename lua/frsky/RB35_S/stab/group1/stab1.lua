...
local parameters = {
  ...
  {"Gyro mode switch", createNumberField, 0xBA, 2, nil, 0, 23, "", -1, "CH "},
  {"Gyro mode at -100%", createChoiceField, 0xBC, 1, nil, {{"Stabilization", 0}, {"Auto level", 1}, {"Hover", 2}, {"Knife edge", 3}, {"Off", 4}, {"Heading hold", 5}}},
  {"Gyro mode at 0%", createChoiceField, 0xBC, 2, nil, {{"Stabilization", 0}, {"Auto level", 1}, {"Hover", 2}, {"Knife edge", 3}, {"Off", 4}, {"Heading hold", 5}}},
  {"Gyro mode at 100%", createChoiceField, 0xBC, 3, nil, {{"Stabilization", 0}, {"Auto level", 1}, {"Hover", 2}, {"Knife edge", 3}, {"Off", 4}, {"Heading hold", 5}}},
  ...
  {"Stab & auto lvl gain adj. CH", createNumberField, 0xBA, 1, nil, 0, 23, "", -1, "CH "},
  ...
  {STR("CHAutoLvlGain", {CH = "ELE"}), createNumberField, 0xAC, 2, nil, 0, 200, "%"},
  ...
  {"Heading hold gain roll", createNumberField, 0xBB, 1, nil, 0, 255, "%"},
  {"Heading hold gain pitch", createNumberField, 0xBB, 2, nil, 0, 255, "%"},
  {"Heading hold gain yaw", createNumberField, 0xBB, 3, nil, 0, 255, "%"},
  ...
  -- {"Heading hold", createChoiceField, 0xBB, 1, nil, {{STR("Off"), 0}, {STR("On"), 1}}},
  -- {"Angle velocity roll", createNumberField, 0xBB, {2, 3}, nil, 0, 1000, " deg"},
  -- {"Angle V. gain pitch", createNumberField, 0xBC, 1, nil, 0, 200, "%"},
  -- {"Angle velocity pitch", createNumberField, 0xBC, {2, 3}, nil, 0, 1000, " deg"},
  -- {"Angle V. gain yaw", createNumberField, 0xBD, 1, nil, 0, 200, "%"},
  -- {"Angle velocity yaw", createNumberField, 0xBD, {2, 3}, nil, 0, 1000, " deg"},
}
