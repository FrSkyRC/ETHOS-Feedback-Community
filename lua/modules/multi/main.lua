...
local function init()
    ...
    system.registerMultimoduleProtocol("Futaba/SFHSS", 21, {variants={"SFHSS"}, features=FAILSAFE, options={RF_TUNE_OPTION}})
    system.registerMultimoduleProtocol("FX", 58, {variants={"816", "620", "9630", "Q560", "QF012"}})
