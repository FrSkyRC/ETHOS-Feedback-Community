# Matrix theme for ETHOS

> Green-on-black terminal theme inspired by the Matrix digital rain
...
| | |
| :---: | :---: |
| ![Matrix](screenshots/matrix.png) | ![Matrix Channels](screenshots/matrix-channels.png) |
| ![Matrix Model](screenshots/matrix-model.png) | ![Matrix General](screenshots/matrix-general.png) |
